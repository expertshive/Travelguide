...
export const INTEGRATION_CATALOG: readonly IntegrationDefinition[] = [
  ...
  },
  {
    ...
    vendor: 'ElevenLabs',
    description:
      'Natural text-to-speech for turn-by-turn guidance and assistant replies. The app requests audio server-side and plays it. Device TTS is only a fallback if this key is missing.',
    usedBy: ['ai-service'],
    ...
    fields: [
      ...
      },
      {
        ...
        help: 'Leave blank to auto-pick. Hindi/Urdu always use eleven_v3 (the older multilingual_v2 model cannot pronounce them clearly).',
      },
      {
