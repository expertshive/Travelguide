...
export const INTEGRATION_CATALOG: readonly IntegrationDefinition[] = [
  ...
  },
  {
    ...
    vendor: 'Google AI',
    description:
      'Optional fallback if ChatGPT is unset or fails. Speech no longer uses Gemini.',
    usedBy: ['ai-service'],
    ...
    fields: [
      ...
      },
      {
        ...
        help: 'Defaults to gemini-2.5-flash. Only used if OpenAI is missing or errors.',
      },
    ],
  },
  {
    ...
    vendor: 'OpenAI',
    description:
      'Travel-assistant brain and spoken voice (OpenAI TTS). ChatGPT replies and the copilot voice both use this key.',
    usedBy: ['ai-service'],
    ...
    fields: [
      ...
      },
      {
        ...
        help: 'Chat model. Defaults to gpt-4o-mini. Speech uses gpt-4o-mini-tts, then tts-1.',
      },
    ],
  },
  {
